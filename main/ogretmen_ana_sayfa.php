...
require_once 'ogretmen_islemleri.php'; 
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            modalConfirmBtn.addEventListener('click', async function() {
                ...
                } else if (modalMessage.textContent.includes('Hesabınızı silmek')) { 
                    deleteAccount();
                }
            ...
            async function loadAllStudents() {
                ...
                try {
                    ...
                    tumOgrencilerListesi.innerHTML = ''; 
            ...
            async function loadTeacherAppointments() {
                ...
                try {
                    ...
                    randevuTalepleriListesi.innerHTML = ''; 
            ...
            function deleteAccount() {
                ...
                fetch(`hesap_sil.php`, { method: 'POST' }) 
