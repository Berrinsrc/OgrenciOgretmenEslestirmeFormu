...
require_once 'ogrenci_islemleri.php'; 
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            async function loadOgretmenler() {
                ...
                const saat = randevuSaatiInput.value; 
                ...
                if (dersId && tarih && saat) {
                    try {
                        const response = await fetch(`musait_ogretmenleri_getir.php?ders_id=${dersId}&randevu_tarihi=${tarih}&randevu_saati=${saat}`); 
                        const data = await response.json();

                        ogretmenSelect.innerHTML = ''; 
            ...
            async function loadBekleyenRandevular() {
                ...
                try {
                    ...
                    bekleyenRandevularListesi.innerHTML = ''; 
            ...
            randevuForm.addEventListener('submit', async function(event) {
                ...
                submitButton.textContent = 'Randevu Oluşturuluyor...'; 
                ...
                try {
                    ...
                    submitButton.textContent = 'Randevu Oluştur'; 
                }
            });
